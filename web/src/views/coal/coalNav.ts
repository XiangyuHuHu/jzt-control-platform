...
export const coalPrimaryEntries: CoalNavItem[] = [
  ...
  { label: '生产调度', path: '/coal/production', desc: '生产流程、班组交接、调度记录与异常处置整合' },
  { label: '设备管理', path: '/coal/equipment', desc: '设备状态、台账、故障分析、电机和变频器数据' },
...
export const coalTopicEntries: CoalNavItem[] = [
  ...
  { label: '能耗管理', path: '/coal/energy', desc: '耗电量录入、水耗、药剂、油脂和水平衡' },
  { label: '协同管理', path: '/coal/collaboration', desc: '待办事项、跨部门工单、闭环进度与值班协同' },
  { label: '智能决策', path: '/coal/decision', desc: '产品方案、质量预测、设备故障分析与优化建议' },
...
export const coalProductionExtensionEntries: CoalNavItem[] = [
  ...
  { label: '水耗与水平衡', path: '/coal/water', desc: '补水汇总、循环水、煤泥水与水平衡分析' },
  { label: '电耗台账', path: '/coal/power', desc: '耗电量录入、配电状态、电耗台账与报警分析' },
  { label: '油脂消耗', path: '/coal/grease', desc: '油脂领用、班报月报与异常追踪' },
  { label: '用风量', path: '/coal/air', desc: '流量采集、单位风耗与考核依据' },
  { label: '排班管理', path: '/coal/shift-schedule', desc: '二班倒、三班倒、生产班与检修班配置' },
]
...
export const coalExtensionEntries: CoalNavItem[] = [
  ...
  { label: '销售统计', path: '/coal/sales', desc: '按日期、产品、客户和运输方式统计销售质量' },
...
export const coalQuickNav: CoalNavItem[] = [
  ...
  { label: '质量能耗', path: '/coal/quality' },
  { label: '智能优化', path: '/coal/decision' },
  { label: '平台系统', path: '/coal/settings' },
]
